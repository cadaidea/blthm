...
const tr = (daysAgo: number, hour: number, user: string, msg: string) => ({
  ts: daysAgoIso(daysAgo, hour), user, msg,
});
...
export const seedState = (): AppState => ({
  ...
  orders: [
    {
      ...
      items: [{ productId: "p1", sku: "SAL-001", name: "Sofá Nápoles 3 puestos", qty: 1, price: 899 }],
      subtotal: 899, iva: 134.85, total: 1033.85, status: "despachado", channel: "tienda", payment: "pagado",
      transportId: "s5", bultos: 3, createdAt: daysAgoIso(4, 11), eta: inDaysIso(1), city: "Quito", workOrderId: null,
      trace: [tr(4, 11, "Paola C.", "Venta de stock creada · canal tienda"), tr(4, 12, "sistema", "Link PayPhone pagado · $1.033,85 · Visa •••• 4421"), tr(0, 9, "Luis Ch.", "3 bultos cargados · TransLog Ecuador PCH-1194")],
      recibos: [{ id: "r1", code: "REC-0405", date: daysAgoIso(4, 12), amount: 1033.85, method: "PayPhone · Visa •••• 4421", note: "Pago total vía link" }],
      confirmToken: null, confirmedAt: null,
    },
    {
      id: "o2", code: "PED-1042", kind: "venta", customerId: "c2", customer: "Corporación Quiport Offices",
      items: [{ productId: "p5", sku: "OFI-007", name: "Escritorio Ejecutivo Cañar", qty: 6, price: 449 }, { productId: "p6", sku: "SAL-023", name: "Poltrona Esmeraldas", qty: 4, price: 389 }],
      subtotal: 4250, iva: 637.5, total: 4887.5, status: "aprobado", channel: "link_pago", payment: "pendiente",
      transportId: "s5", bultos: 10, createdAt: daysAgoIso(3, 15), eta: inDaysIso(6), city: "Quito", workOrderId: null,
      trace: [tr(3, 15, "Paola C.", "Venta de stock creada · canal link de pago"), tr(3, 16, "sistema", "Link de cobro pp_9Kf3… enviado a compras@quiport-offices.ec")],
    ...
    },
    {
      ...
      items: [{
        ...
        spec: {
          tapiz: "Lino crudo T-04", tapizSec: "Chenille plomo (asiento)", cojines: "2 rectangulares plomo por silla",
    ...
    },
    {
      ...
      items: [{ productId: "p3", sku: "DOR-030", name: "Cama King Roble Nórdica", qty: 1, price: 699 }, { productId: "p8", sku: "DOR-051", name: "Base + Colchón Queen Ortopédico", qty: 1, price: 559 }],
    ...
    },
    {
      ...
      items: [{ productId: "p6", sku: "SAL-023", name: "Poltrona Esmeraldas", qty: 12, price: 369 }],
      ...
      trace: [tr(18, 12, "Paola C.", "Venta de stock creada · canal link de pago"), tr(17, 10, "sistema", "Link PayPhone pagado · $5.092,20"), tr(4, 8, "Luis Ch.", "Guía de remisión 001-001-000000023 autorizada SRI"), tr(2, 11, "Mónica S.", "Entregado en Centro Histórico · 12 bultos conformados")],
      recibos: [{ id: "r3", code: "REC-0408", date: daysAgoIso(17, 10), amount: 5092.2, method: "PayPhone · Visa", note: "Pago total vía link" }],
      confirmToken: null, confirmedAt: null,
    },
    {
      id: "o6", code: "PED-1036", kind: "pedido", customerId: "c3", customer: "Distribuidora Mueblisur",
      items: [{ productId: "p1", sku: "SAL-001", name: "Sofá Nápoles 3 puestos", qty: 4, price: 829, spec: { tapiz: "Chenille grafito", tapizSec: "—", cojines: "Estándar", lacado: "Walnut semi-brillo", notas: "Sin logos, embalaje mayorista", fotos: [{ campo: "Tapiz principal", label: "chenille-grafito.jpg" }] } }, { productId: "p4", sku: "DOR-042", name: "Ropero Amazonia 6 puertas", qty: 2, price: 749 }],
      subtotal: 4814, iva: 722.1, total: 5536.1, status: "listo_despacho", channel: "web", payment: "pendiente",
      transportId: "s6", bultos: 16, createdAt: daysAgoIso(8, 16), eta: inDaysIso(3), city: "Guayaquil", workOrderId: "w2",
      trace: [tr(8, 16, "Paola C.", "Pedido bajo specs creado · canal web (mayorista)"), tr(8, 17, "sistema", "Link único de confirmación enviado a pedidos@mueblisur.ec"), tr(7, 12, "cliente", "Cliente confirmó specs del link único"), tr(2, 16, "Segundo M.", "OF-2102 en acabado · 78%")],
      recibos: [], confirmToken: "cf_Pq44vNz1Rt", confirmedAt: daysAgoIso(7, 12),
    },
    {
      id: "o7", code: "PED-1030", kind: "venta", customerId: "c2", customer: "Corporación Quiport Offices",
      items: [{ productId: "p7", sku: "COM-015", name: "Silla Comedor Andina (und)", qty: 24, price: 92 }],
      subtotal: 2208, iva: 331.2, total: 2539.2, status: "entregado", channel: "tienda", payment: "pagado",
      transportId: "s5", bultos: 12, createdAt: daysAgoIso(25, 10), eta: daysAgoIso(9), city: "Quito", workOrderId: null,
      trace: [tr(25, 10, "Paola C.", "Venta de stock creada · canal tienda"), tr(24, 9, "Rocío M.", "Recibo REC-0398 · pago total por transferencia"), tr(9, 15, "Paúl V.", "Entregado en oficina matriz")],
      recibos: [{ id: "r4", code: "REC-0398", date: daysAgoIso(24, 9), amount: 2539.2, method: "Transferencia Bco. Pichincha", note: "Pago total" }],
      confirmToken: null, confirmedAt: null,
    },
    {
      id: "o8", code: "PED-1045", kind: "pedido", customerId: "c4", customer: "Estudio Arq. Barragán",
      items: [{ productId: "p4", sku: "DOR-042", name: "Ropero Amazonia 6 puertas", qty: 1, price: 789, spec: { tapiz: "—", tapizSec: "—", cojines: "—", lacado: "Grafito mate", notas: "Tiradores ocultos · interior cedro", fotos: [{ campo: "Lacado", label: "grafito-mate.jpg" }] } }],
      ...
      trace: [tr(0, 8, "sistema", "Pedido bajo specs recibido desde catálogo web"), tr(0, 9, "sistema", "Link único de confirmación (con fotos) pendiente de enviar")],
      recibos: [], confirmToken: null, confirmedAt: null,
    },
  ],
  movements: [
    { id: "mv1", ts: daysAgoIso(0, 9), type: "egreso", warehouse: "showroom", productId: "p1", sku: "SAL-001", productName: "Sofá Nápoles 3 puestos", qty: 1, ref: "PED-1041", user: "Paola C." },
  ...
  payLinks: [
    ...
    { id: "pl2", token: "pp_T7bNcV4jH1sQ", concept: "Saldo pedido · PED-1036 Mueblisur", orderId: "o6", amount: 5536.1, customerName: "Distribuidora Mueblisur", createdAt: daysAgoIso(2, 9), expiresAt: inDaysIso(5), status: "pendiente", method: null, authCode: null, last4: null },
  ...
  accessLinks: [
    ...
    { id: "al2", token: "ac_H7sRd3pN6cJf", label: "Cobranzas semana — Rocío", role: "contabilidad", scope: "CxC y conciliación", createdAt: daysAgoIso(1, 8), expiresAt: inDaysIso(6), maxUses: 1, uses: 0, status: "activo" },
  ...
  media: [
    ...
    { id: "m2", name: "comedor-andino-estudio.jpg", kind: "foto", tag: "Comedor", size: "2,1 MB", src: "https://image.qwenlm.ai/generated-images/c4c2d864-549d-421e-a9e9-ee3f14fc7e78/_result.png", usage: ["PIM · COM-014", "Link confirmación PED-1043"], uploadedAt: daysAgoIso(28) },
  ...
  journal: [
    ...
    { id: "j14", date: daysAgoIso(8, 14), doc: "FAC-000229", account: "1020 Bancos Pichincha", detail: "Cobro PayPhone · anticipo Mueblisur", debit: 2768.05, credit: 0 },
    { id: "j15", date: daysAgoIso(8, 14), doc: "FAC-000229", account: "2050 Anticipos clientes", detail: "Anticipo 50% PED-1036", debit: 0, credit: 2768.05 },
  ],
  invoices: [
  ...
  notas: [
    { id: "nc1", number: "001-001-000000012", auth: "1508202502179234567800112345678914509876543214423", invoiceNumber: "001-001-000000219", customer: "Distribuidora Mueblisur", date: daysAgoIso(45, 10), motivo: "Devolución 1 silla con tapiz manchado", amount: 99 },
  ],
  despachos: [
    {
      id: "d1", code: "DSP-3018", orderId: "o5", orderCode: "PED-1038", customer: "Hotel Plaza Grande Suites", city: "Quito",
      transportId: "s6", placa: "GSB-4821", conductor: "Orlando Maza", motivo: "venta",
      fecha: daysAgoIso(4, 8), ruta: "Bodega Central (Calderón) → Centro Histórico, Quito", bultos: 12, pesoKg: 312,
      guia: { numero: "001-001-000000023", auth: "0409202507179234567800112345678914509876543217781", xml: "<guiaRemision><motivo>Venta</motivo><transportista><razonSocial>Fletes Rápidos GYE</razonSocial><placa>GSB-4821</placa></transportista><ruta>Bodega Central → Centro Histórico</ruta></guiaRemision>" },
      estado: "entregado",
    },
    {
      id: "d2", code: "DSP-3021", orderId: "o1", orderCode: "PED-1041", customer: "María Fernanda Icaza", city: "Quito",
      transportId: "s5", placa: "PCH-1194", conductor: "Héctor Toapanta", motivo: "venta",
      fecha: daysAgoIso(0, 9), ruta: "Bodega Central (Calderón) → Cumbayá, Quito", bultos: 3, pesoKg: 74,
      guia: null, estado: "en_ruta",
    },
  ],
  materials: [
    { id: "mat1", code: "MP-001", name: "Tabla laurel 2\"", unit: "m³", stock: 2.4, min: 1, costUnit: 145, supplierId: "s1" },
    { id: "mat2", code: "MP-002", name: "Tabla roble 2\"", unit: "und", stock: 40, min: 20, costUnit: 23, supplierId: "s1" },
    { id: "mat3", code: "MP-003", name: "Cuadrante roble 5×5", unit: "m", stock: 300, min: 150, costUnit: 3, supplierId: "s1" },
    { id: "mat4", code: "MP-004", name: "Espuma D30 (plancha)", unit: "und", stock: 35, min: 24, costUnit: 7, supplierId: "s2" },
    { id: "mat5", code: "MP-005", name: "Lino crudo T-04", unit: "m", stock: 80, min: 40, costUnit: 11, supplierId: "s3" },
    { id: "mat6", code: "MP-006", name: "Bouclé esmeralda", unit: "m", stock: 25, min: 15, costUnit: 19, supplierId: "s3" },
    { id: "mat7", code: "MP-007", name: "Triplex 18mm", unit: "plan", stock: 18, min: 10, costUnit: 47, supplierId: "s1" },
    { id: "mat8", code: "MP-008", name: "Canto PVC nogal", unit: "m", stock: 200, min: 100, costUnit: 0.8, supplierId: "s2" },
    { id: "mat9", code: "MP-009", name: "Laca poliuretano mate", unit: "L", stock: 30, min: 12, costUnit: 9.5, supplierId: "s2" },
    { id: "mat10", code: "MP-010", name: "Cincha elástica", unit: "m", stock: 150, min: 60, costUnit: 0.6, supplierId: "s2" },
    { id: "mat11", code: "MP-011", name: "Base giratoria metálica", unit: "und", stock: 4, min: 6, costUnit: 22, supplierId: "s4" },
    { id: "mat12", code: "MP-012", name: "Tornillería mixta", unit: "kg", stock: 25, min: 10, costUnit: 4.2, supplierId: "s2" },
  ],
  boms: [
    { productId: "p1", lines: [{ materialId: "mat1", qty: 0.18, unit: "m³" }, { materialId: "mat4", qty: 4, unit: "und" }, { materialId: "mat5", qty: 12, unit: "m" }, { materialId: "mat10", qty: 20, unit: "m" }, { materialId: "mat9", qty: 0.5, unit: "L" }], laborMin: 960 },
    { productId: "p2", lines: [{ materialId: "mat2", qty: 7, unit: "und" }, { materialId: "mat5", qty: 4.5, unit: "m" }, { materialId: "mat4", qty: 6, unit: "und" }, { materialId: "mat9", qty: 0.8, unit: "L" }], laborMin: 1200 },
    { productId: "p4", lines: [{ materialId: "mat7", qty: 3, unit: "plan" }, { materialId: "mat8", qty: 30, unit: "m" }, { materialId: "mat12", qty: 0.4, unit: "kg" }, { materialId: "mat9", qty: 1.2, unit: "L" }], laborMin: 1440 },
    { productId: "p6", lines: [{ materialId: "mat6", qty: 2.7, unit: "m" }, { materialId: "mat11", qty: 1, unit: "und" }, { materialId: "mat4", qty: 2, unit: "und" }], laborMin: 480 },
    { productId: "p7", lines: [{ materialId: "mat3", qty: 4, unit: "m" }, { materialId: "mat5", qty: 0.8, unit: "m" }, { materialId: "mat12", qty: 0.15, unit: "kg" }], laborMin: 150 },
  ],
  events: [
    { id: "e1", ts: Date.now() - 42_000, type: "pago", msg: "PayPhone confirmó $2.443,75 · anticipo PED-1042" },
    { id: "e2", ts: Date.now() - 96_000, type: "logistica", msg: "DSP-3021 en ruta · TransLog Ecuador · PCH-1194" },
    { id: "e3", ts: Date.now() - 180_000, type: "web", msg: "Cliente Barragán confirmó specs del link único (con fotos)" },
    { id: "e4", ts: Date.now() - 300_000, type: "taller", msg: "OF-2101 pasó a ENSAMBLAJE · Diego Guamán" },
    { id: "e5", ts: Date.now() - 420_000, type: "factura", msg: "Guía de remisión 001-001-000000023 autorizada por SRI" },
  ],
  team: [
  ...
  settings: {
    ...
    sequence: { invoice: 232, order: 1046, link: 128, recibo: 413, despacho: 3022, guia: 24, nc: 13 },
  },
