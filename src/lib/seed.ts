...
export const seedState = (): AppState => ({
  hydrated: true,
  products: [
    { id: "p1", sku: "SAL-001", name: "Sofá Nápoles 3 puestos", category: "Sala", line: "fabricacion", materials: ["Madera de laurel", "Lino crudo", "Espuma D30"], cost: 480, price: 899, stock: { showroom: 3, bodega: 5, taller: 0 }, min: 3, status: "activo", img: "/img/p1.jpg", mediaIds: ["m1"], dims: "220×92×86 cm", weightKg: 68, leadDays: 21, createdAt: daysAgoIso(220) },
    { id: "p2", sku: "COM-014", name: "Comedor Andino 6 sillas", category: "Comedor", line: "fabricacion", materials: ["Roble nacional", "Acabado natural", "Sillas tapizadas"], cost: 620, price: 1189, stock: { showroom: 2, bodega: 3, taller: 2 }, min: 2, status: "activo", img: "/img/p2.jpg", mediaIds: ["m2"], dims: "180×100×76 cm", weightKg: 84, leadDays: 25, createdAt: daysAgoIso(190) },
    { id: "p3", sku: "DOR-030", name: "Cama King Roble Nórdica", category: "Dormitorio", line: "compra_local", materials: ["Roble", "Ensamble invisible"], cost: 350, price: 699, stock: { showroom: 1, bodega: 6, taller: 0 }, min: 2, status: "activo", img: "/img/p3.jpg", mediaIds: ["m3"], dims: "210×190×105 cm", weightKg: 72, leadDays: 12, createdAt: daysAgoIso(160) },
    { id: "p4", sku: "DOR-042", name: "Ropero Amazonia 6 puertas", category: "Dormitorio", line: "fabricacion", materials: ["Laurel", "Triplex 18mm", "Bisagras slow-close"], cost: 410, price: 789, stock: { showroom: 2, bodega: 2, taller: 1 }, min: 2, status: "activo", img: "/img/p4.jpg", mediaIds: ["m4"], dims: "240×60×210 cm", weightKg: 110, leadDays: 28, createdAt: daysAgoIso(140) },
    { id: "p5", sku: "OFI-007", name: "Escritorio Ejecutivo Cañar", category: "Oficina", line: "compra_local", materials: ["Nogal", "Pasacables", "Cajonera doble"], cost: 240, price: 459, stock: { showroom: 4, bodega: 7, taller: 0 }, min: 3, status: "activo", img: "/img/p5.jpg", mediaIds: ["m5"], dims: "160×75×76 cm", weightKg: 54, leadDays: 10, createdAt: daysAgoIso(120) },
    { id: "p6", sku: "SAL-023", name: "Poltrona Esmeraldas", category: "Sala", line: "importado", materials: ["Bouclé", "Base giratoria metal"], cost: 190, price: 389, stock: { showroom: 6, bodega: 4, taller: 0 }, min: 3, status: "activo", img: "/img/p6.jpg", mediaIds: ["m6"], dims: "88×90×102 cm", weightKg: 26, leadDays: 35, createdAt: daysAgoIso(100) },
  ...
  suppliers: [
    ...
    { id: "s2", name: "Espumas del Pacífico", kind: "insumos", contact: "Karla Merchán", phone: "04 248 9902", email: "kmerchan@espumas pacifico.ec".replace(" ", ""), city: "Guayaquil", rating: 4.2, leadDays: 4, balance: 0, items: "Espuma D26/D30, guata, cincha", active: true },
  ...
  orders: [
    { id: "o1", code: "PED-1041", customerId: "c1", customer: "María Fernanda Icaza", items: [{ productId: "p1", sku: "SAL-001", name: "Sofá Nápoles 3 puestos", qty: 1, price: 899 }], subtotal: 899, iva: 134.85, total: 1033.85, status: "despacho", channel: "tienda", payment: "pagado", transportId: "s5", createdAt: daysAgoIso(4, 11), eta: inDaysIso(1), city: "Quito", workOrderId: null },
    { id: "o2", code: "PED-1042", customerId: "c2", customer: "Corporación Quiport Offices", items: [{ productId: "p5", sku: "OFI-007", name: "Escritorio Ejecutivo Cañar", qty: 6, price: 449 }, { productId: "p6", sku: "SAL-023", name: "Poltrona Esmeraldas", qty: 4, price: 389 }], subtotal: 4250, iva: 637.5, total: 4887.5, status: "confirmado", channel: "link_pago", payment: "parcial", transportId: "s5", createdAt: daysAgoIso(3, 15), eta: inDaysIso(6), city: "Quito", workOrderId: null },
    { id: "o3", code: "PED-1043", customerId: "c4", customer: "Estudio Arq. Barragán", items: [{ productId: "p2", sku: "COM-014", name: "Comedor Andino 6 sillas", qty: 2, price: 1189 }], subtotal: 2378, iva: 356.7, total: 2734.7, status: "fabricacion", channel: "web", payment: "parcial", transportId: null, createdAt: daysAgoIso(6, 9), eta: inDaysIso(9), city: "Cuenca", workOrderId: "w1" },
    { id: "o4", code: "PED-1044", customerId: "c5", customer: "Javier Andrade Vallejo", items: [{ productId: "p3", sku: "DOR-030", name: "Cama King Roble Nórdica", qty: 1, price: 699 }, { productId: "p8", sku: "DOR-051", name: "Base + Colchón Queen Ortopédico", qty: 1, price: 559 }], subtotal: 1258, iva: 188.7, total: 1446.7, status: "nuevo", channel: "whatsapp", payment: "pendiente", transportId: null, createdAt: daysAgoIso(0, 9), eta: inDaysIso(5), city: "Ambato", workOrderId: null },
    { id: "o5", code: "PED-1038", customerId: "c6", customer: "Hotel Plaza Grande Suites", items: [{ productId: "p6", sku: "SAL-023", name: "Poltrona Esmeraldas", qty: 12, price: 369 }], subtotal: 4428, iva: 664.2, total: 5092.2, status: "entregado", channel: "link_pago", payment: "pagado", transportId: "s6", createdAt: daysAgoIso(18, 12), eta: daysAgoIso(2), city: "Quito", workOrderId: null },
    { id: "o6", code: "PED-1036", customerId: "c3", customer: "Distribuidora Mueblisur", items: [{ productId: "p1", sku: "SAL-001", name: "Sofá Nápoles 3 puestos", qty: 4, price: 829 }, { productId: "p4", sku: "DOR-042", name: "Ropero Amazonia 6 puertas", qty: 2, price: 749 }], subtotal: 4814, iva: 722.1, total: 5536.1, status: "listo", channel: "web", payment: "pendiente", transportId: "s6", createdAt: daysAgoIso(8, 16), eta: inDaysIso(3), city: "Guayaquil", workOrderId: "w2" },
    { id: "o7", code: "PED-1030", customerId: "c2", customer: "Corporación Quiport Offices", items: [{ productId: "p7", sku: "COM-015", name: "Silla Comedor Andina (und)", qty: 24, price: 92 }], subtotal: 2208, iva: 331.2, total: 2539.2, status: "entregado", channel: "tienda", payment: "pagado", transportId: "s5", createdAt: daysAgoIso(25, 10), eta: daysAgoIso(9), city: "Quito", workOrderId: null },
    { id: "o8", code: "PED-1045", customerId: "c4", customer: "Estudio Arq. Barragán", items: [{ productId: "p4", sku: "DOR-042", name: "Ropero Amazonia 6 puertas", qty: 1, price: 789 }], subtotal: 789, iva: 118.35, total: 907.35, status: "nuevo", channel: "web", payment: "pendiente", transportId: null, createdAt: daysAgoIso(0, 8), eta: inDaysIso(12), city: "Cuenca", workOrderId: null },
  ],
  movements: [
  ...
  accessLinks: [
    ...
    { id: "al3", token: "ac_B2mTv9qXw4Ls", label: "Cotización Hotel Plaza Grande", role: "cliente", scope: "Catálogo + cotizador", createdAt: daysAgoIso(2, 15), expiresAt: inDaysIso(3), maxUses: 1, uses: 0, status: "activo" },
  ...
  media: [
    { id: "m1", name: "sofa-napoles-hero.jpg", kind: "foto", tag: "Sala", size: "2,4 MB", src: "/img/p1.jpg", usage: ["PIM · SAL-001", "Catálogo web"], uploadedAt: daysAgoIso(30) },
    { id: "m2", name: "comedor-andino-estudio.jpg", kind: "foto", tag: "Comedor", size: "2,1 MB", src: "/img/p2.jpg", usage: ["PIM · COM-014", "Instagram"], uploadedAt: daysAgoIso(28) },
    { id: "m3", name: "cama-king-roble.jpg", kind: "foto", tag: "Dormitorio", size: "1,9 MB", src: "/img/p3.jpg", usage: ["PIM · DOR-030"], uploadedAt: daysAgoIso(25) },
    { id: "m4", name: "ropero-amazonia-amb.jpg", kind: "foto", tag: "Dormitorio", size: "2,6 MB", src: "/img/p4.jpg", usage: ["PIM · DOR-042"], uploadedAt: daysAgoIso(21) },
    { id: "m5", name: "escritorio-canar.jpg", kind: "foto", tag: "Oficina", size: "1,7 MB", src: "/img/p5.jpg", usage: ["PIM · OFI-007", "Link cotización"], uploadedAt: daysAgoIso(18) },
    { id: "m6", name: "poltrona-esmeraldas.jpg", kind: "foto", tag: "Sala", size: "2,2 MB", src: "/img/p6.jpg", usage: ["PIM · SAL-023", "Catálogo web", "Meta Ads"], uploadedAt: daysAgoIso(15) },
  ...
  events: [
    ...
    { id: "e2", ts: Date.now() - 96_000, type: "stock", msg: "Ingreso bodega +4 · DOR-030 Cama King Roble" },
    { id: "e3", ts: Date.now() - 180_000, type: "web", msg: "Visita a link de un solo uso · catálogo Mueblisur" },
    { id: "e4", ts: Date.now() - 300_000, type: "taller", msg: "OF-2101 pasó a ENSAMBLAJE · Diego Guamán" },
    { id: "e5", ts: Date.now() - 420_000, type: "factura", msg: "FAC-000231 autorizada por SRI · Hotel Plaza Grande" },
  ],
  team: [
  ...
  settings: {
    ...
    sequence: { invoice: 232, order: 1046, link: 128 },
  },
